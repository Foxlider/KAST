...
public interface ISteamService
{
    ...
    // ── Steam operations ──
    Task<ulong> DownloadWorkshopItemAsync(long workshopId, string destinationPath, IProgress<double>? progress = null, int maxParallelDownloads = 4, CancellationToken ct = default);
